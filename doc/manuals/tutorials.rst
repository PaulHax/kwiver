...
Each file is designed to demonstrate a particular feature in kwiver.
...
The following example sprokit pipelines are provided to demonstrate using these algorithms and types in a streaming process.
