...
static std::string valid_config =
  "config_files/vital/test_config-valid_file.txt";
static std::string include_a_config =
  "config_files/vital/test_config-include-a.txt";
static std::string include_files_in_path_config =
  "config_files/vital/test_config-include_files_in_path.txt";
static std::string invalid_config =
  "config_files/vital/test_config-invalid_file.txt";
static std::string invalid_keypath_config =
  "config_files/vital/test_config-invalid_keypath.txt";
static std::string comments_config =
  "config_files/vital/test_config-comments.txt";
static std::string standard_config =
  "config_files/vital/test_config-standard.txt";
static std::string standard_config_name = "test_config-standard.txt";
static std::string first_directory =
  "config_files/vital/test_config-standard-dir-first";
static std::string second_directory =
  "config_files/vital/test_config-standard-dir-second";
...
void
print_config(
  config_block_sptr const& config, bool include_location = false,
...
{
  config_block_sptr config = kwiver::vital::read_config_file(
    data_dir + "/" +
    valid_config );
...
TEST_F ( config_block_io, write_config_simple_success )
{
  ...
  config_block_description_t descrD =
    config_block_description_t( "Test descr 1" );
  ...
  for( config_block_sptr config : configs )
  {
    ...
    EXPECT_EQ(
      valueC,
      config->get_value< config_block_value_t >(
        subblock_name +
