 ...
 */
VITAL_C_EXPORT
char const* vital_algorithm_type_name(
...
VITAL_C_EXPORT                                                          \
void                                                                    \
vital_algorithm_##type##_destroy(                                       \
  vital_algorithm_t * algo,                                             \
  vital_error_handle_t * eh );                                          \
                                                                        \
...
VITAL_C_EXPORT                                                          \
void                                                                    \
vital_algorithm_##type##_registered_names(                              \
  unsigned int* length,                                                 \
  char*** names );                                                      \
                                                                        \
...
VITAL_C_EXPORT                                                               \
void                                                                         \
vital_algorithm_##type##_get_type_config(                                    \
  char const* name,                                                          \
  vital_algorithm_t const* algo,                                             \
  vital_config_block_t * cb,                                                 \
  vital_error_handle_t * eh );                                               \
...
VITAL_C_EXPORT                                                     \
void                                                               \
vital_algorithm_##type##_set_type_config(                          \
  char const* name,                                                \
...
VITAL_C_EXPORT                                                     \
bool                                                               \
vital_algorithm_##type##_check_type_config(                        \
  char const* name,                                                \
  vital_config_block_t const* cb,                                  \
  vital_error_handle_t * eh );
