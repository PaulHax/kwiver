...
VITAL_C_EXPORT
vital_detected_object_t* vital_detected_object_copy(
...
VITAL_C_EXPORT
void vital_detected_object_set_bounding_box(
  vital_detected_object_t* obj,
  vital_bounding_box_t* bbox );
...
VITAL_C_EXPORT
void vital_detected_object_set_confidence(
  vital_detected_object_t* obj,
  double conf );
...
VITAL_C_EXPORT
void vital_detected_object_set_type(
  vital_detected_object_t* obj,
...
VITAL_C_EXPORT
void vital_detected_object_set_index(
  vital_detected_object_t* obj,
  int64_t idx );
...
VITAL_C_EXPORT
void vital_detected_object_detector_setname(
  vital_detected_object_t* obj,
  char* name );
...
VITAL_C_EXPORT
void vital_detected_object_set_mask(
  vital_detected_object_t* obj,
  vital_image_t* mask );
