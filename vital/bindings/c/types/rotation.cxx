...
void                                                                      \
vital_rotation_##S##_destroy(                                             \
  vital_rotation_##S##_t * rot,                                           \
...
vital_rotation_##S##_t*                                                   \
vital_rotation_##S##_new_from_quaternion(                                 \
  vital_eigen_matrix4x1##S##_t * q,                                       \
  vital_error_handle_t * eh )                                             \
{                                                                         \
  typedef kwiver::vital::rotation_< T > rotation_t;                       \
...
vital_rotation_##S##_t*                                                   \
vital_rotation_##S##_new_from_rodrigues(                                  \
  vital_eigen_matrix3x1##S##_t * r,                                       \
  vital_error_handle_t * eh )                                             \
{                                                                         \
  typedef kwiver::vital::rotation_< T > rotation_t;                       \
...
vital_rotation_##S##_t*                                                   \
vital_rotation_##S##_new_from_axis_angle(                                 \
  T angle,                                                                \
...
vital_rotation_##S##_t*                                                   \
vital_rotation_##S##_new_from_ypr(                                        \
...
vital_rotation_##S##_t*                                                   \
vital_rotation_##S##_new_from_matrix(                                     \
  vital_eigen_matrix3x3##S##_t * m,                                       \
  vital_error_handle_t * eh )                                             \
{                                                                         \
  typedef kwiver::vital::rotation_< T > rotation_t;                       \
 ...
 */                                                                             \
vital_rotation_##S##_t*                                                         \
vital_rotation_##S##_compose(                                                   \
  vital_rotation_##S##_t * lhs,                                                 \
...
vital_eigen_matrix3x1##S##_t*                                                   \
vital_rotation_##S##_rotate_vector(                                             \
  vital_rotation_##S##_t * rot,                                                 \
...
bool                                                                            \
vital_rotation_##S##_are_equal(                                                 \
  vital_rotation_##S##_t * A,                                                   \
...
vital_rotation_##S##_t*                                                         \
vital_rotation_##S##_interpolate(                                               \
  vital_rotation_##S##_t * A,                                                   \
  vital_rotation_##S##_t * B,                                                   \
  T f,                                                                          \
  vital_error_handle_t * eh )                                                   \
...
vital_rotation_##S##_t**                                                        \
vital_rotation_##S##_interpolated_rotations(                                    \
  vital_rotation_##S##_t * A,                                                   \
  vital_rotation_##S##_t * B,                                                   \
  size_t n,                                                                     \
  vital_error_handle_t * eh )                                                   \
{                                                                               \
  ...
  vital_rotation_##S##_t** rots =                                               \
    ( vital_rotation_##S##_t** ) malloc(                                        \
  sizeof( vital_rotation_##S##_t* ) *                                           \
  n );                                                                          \
