...
vital_bounding_box_new_from_vectors( double* ul, double* lr )
{
...
// ------------------------------------------------------------------
vital_bounding_box_t*
vital_bounding_box_new_from_point_width_height(
  double* ul,
  double width,
  double height )
{
...
// ------------------------------------------------------------------
vital_bounding_box_t*
vital_bounding_box_new_from_coordinates(
  double xmin,
  double ymin,
  double xmax,
  double ymax )
...
// ------------------------------------------------------------------
vital_bounding_box_t*
vital_bounding_box_copy( vital_bounding_box_t* bbox )
{
  STANDARD_CATCH(
...
// ------------------------------------------------------------------
void
vital_bounding_box_destroy( vital_bounding_box_t* bbox )
{
  STANDARD_CATCH(
...
double*
vital_bounding_box_center( vital_bounding_box_t* bbox )
{
  STANDARD_CATCH(
    "vital_bounding_box_center", 0,
    point_t ctr =
      reinterpret_cast< kwiver::vital::bounding_box_d* >( bbox )->center();
...
double*
vital_bounding_box_upper_left( vital_bounding_box_t* bbox )
{
  STANDARD_CATCH(
    "vital_bounding_box_upper_left", 0,
    point_t ctr =
      reinterpret_cast< kwiver::vital::bounding_box_d* >( bbox )->upper_left();
    double* retval = new double [ 2 ];
    retval[ 0 ] = ctr( 0 );
    retval[ 1 ] = ctr( 1 );
    return retval;
...
double*
vital_bounding_box_lower_right( vital_bounding_box_t* bbox )
{
  STANDARD_CATCH(
    "vital_bounding_box_lower_right", 0,
    point_t ctr =
      reinterpret_cast< kwiver::vital::bounding_box_d* >( bbox )->lower_right();
    double* retval = new double [ 2 ];
    retval[ 0 ] = ctr[ 0 ];
    retval[ 1 ] = ctr[ 1 ];
    return retval;
