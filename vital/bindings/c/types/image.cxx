  ...
  size_t pixel_num_bytes )
{
  STANDARD_CATCH(
    ...
    pixel_traits pt(
      static_cast< pixel_traits::pixel_type >( pixel_type ),
      pixel_num_bytes );
    return reinterpret_cast< vital_image_t* >(
      new kwiver::vital::image(
        width, height, depth,
        interleave, pt )
    );
  );
...
vital_image_t*
vital_image_new_from_image( vital_image_t* other_image )
{
  STANDARD_CATCH(
    "C::image::new_from_image", 0,
    return reinterpret_cast< vital_image_t* >(
      new kwiver::vital::image(
        *reinterpret_cast< kwiver::vital::image* >( other_image ) )
    );
  );
  return 0;
}
...
void
vital_image_destroy( vital_image_t* image )
{
  STANDARD_CATCH(
    "C::image::destroy", 0,
...
VITAL_C_EXPORT
bool
vital_image_equal_content( vital_image_t* image1, vital_image_t* image2 )
{
  STANDARD_CATCH(
    "C::image::equal_content", 0,
    return kwiver::vital::equal_content(
      *reinterpret_cast< kwiver::vital::image* >( image1 ),
...
TYPE vital_image_get_pixel2_ ## NAME(                                            \
  vital_image_t * image,                                                         \
...
TYPE vital_image_get_pixel3_ ## NAME(                                            \
  vital_image_t * image,                                                         \
  unsigned i, unsigned j,                                                        \
