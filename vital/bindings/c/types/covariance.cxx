...
{                                                                         \
  ...
  return 0;                                                               \
                                                                          ...
                                                                          \
/** Create a new covariance matrix - initialize to identity matrix times a
 * scalar */                                                                     \
vital_covariance_##N##S##_t*                                                     \
vital_covariance_##N##S##_new_from_scalar(                                       \
  T value,                                                                       \
...
vital_covariance_##N##S##_t*                                                     \
vital_covariance_##N##S##_new_from_matrix(                                       \
  vital_eigen_matrix##N##x##N##S##_t * m,                                        \
  vital_error_handle_t * eh )                                                    \
{                                                                                \
  typedef kwiver::vital::covariance_< N, T > cov_t;                              \
...
vital_covariance_##N##S##_t*                                                     \
vital_covariance_##N##S##_new_copy(                                              \
...
void                                                                             \
vital_covariance_##N##S##_destroy(                                               \
  vital_covariance_##N##S##_t * cov,                                             \
  vital_error_handle_t * eh )                                                    \
{                                                                                \
  typedef kwiver::vital::covariance_< N, T > cov_t;                              \
  STANDARD_CATCH(                                                                \
...
void                                                                             \
vital_covariance_##N##S##_set_covariance(                                        \
  vital_covariance_##N##S##_t * cov,                                             \
  vital_covariance_##N##S##_t * other,                                           \
  vital_error_handle_t * eh )                                                    \
{                                                                                \
...
vital_covariance_##N##S##_to_matrix(                                             \
  vital_covariance_##N##S##_t * cov,                                             \
  vital_error_handle_t * eh )                                                    \
{                                                                                \
  typedef kwiver::vital::covariance_< N, T > cov_t;                              \
