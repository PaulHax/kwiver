...
VITAL_C_EXPORT
vital_image_container_t* vital_image_container_from_sptr(
  kwiver::vital::image_container_sptr sptr );

// Return sptr from handle
VITAL_C_EXPORT
kwiver::vital::image_container_sptr vital_image_container_to_sptr(
  vital_image_container_t* handle );
