...
void
vital_descriptor_destroy(
  vital_descriptor_t const* d,
  ...
  vital_error_handle_t* eh )
{
  STANDARD_CATCH(
    ...
    unsigned char* v_ptr = ( unsigned char* ) malloc(
...
T*                                                                               \
vital_descriptor_get_##S##_raw_data(                                             \
...
{                                                                                \
  ...
  TRY_DYNAMIC_CAST( vital::descriptor_dynamic< T >, d_sptr.get(), d_dyn )        \
    {                                                                            \
      POPULATE_EH(                                                               \
  eh, 1, "Failed to dynamic cast descriptor to " #S " type "                     \
                                                    "for data access" );         \
      return 0;                                                                  \
    }                                                                            \
