...
// ------------------------------------------------------------------
// These two functions are a bridge between c++ and the internal smart pointer
// management
// ------------------------------------------------------------------

// Adopt previously created image container
VITAL_C_EXPORT
vital_detected_object_set_t* vital_detected_object_set_from_sptr(
  kwiver::vital::detected_object_set_sptr sptr );

// Return sptr from handle
VITAL_C_EXPORT
kwiver::vital::detected_object_set_sptr vital_detected_object_set_to_sptr(
  vital_detected_object_set_t* handle );
