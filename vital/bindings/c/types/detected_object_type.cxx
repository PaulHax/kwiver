...
// ------------------------------------------------------------------
vital_detected_object_type_t*
vital_detected_object_type_new()
{
  STANDARD_CATCH(
...
// ------------------------------------------------------------------
void
vital_detected_object_type_destroy( vital_detected_object_type_t* obj )
{
  STANDARD_CATCH(
...
// ------------------------------------------------------------------
vital_detected_object_type_t*
vital_detected_object_type_new_from_list(
...
// ------------------------------------------------------------------
bool
vital_detected_object_type_has_class_name(
  vital_detected_object_type_t* obj,
  char* class_name )
{
  STANDARD_CATCH(
    "C::detected_object_type:has_class_name", 0,
    return kwiver::vital_c::DOT_SPTR_CACHE.get( obj )->has_class_name(
...
// ------------------------------------------------------------------
double
vital_detected_object_type_score(
  vital_detected_object_type_t* obj,
  char* class_name )
{
  STANDARD_CATCH(
    "C::detected_object_type:score", 0,
    return kwiver::vital_c::DOT_SPTR_CACHE.get( obj )->score(
      std::string(
        class_name ) );
  );
  return 0;
...
// ------------------------------------------------------------------
char*
vital_detected_object_type_get_most_likely_class(
  vital_detected_object_type_t* obj )
{
  STANDARD_CATCH(
    ...
    std::string class_name;
    double score;
    kwiver::vital_c::DOT_SPTR_CACHE.get( obj )->get_most_likely(
      class_name,
      score );
...
// ------------------------------------------------------------------
double
vital_detected_object_type_get_most_likely_score(
  vital_detected_object_type_t* obj )
{
  STANDARD_CATCH(
...
// ------------------------------------------------------------------
void
vital_detected_object_type_set_score(
  vital_detected_object_type_t* obj,
  char* class_name,
  double score )
{
  STANDARD_CATCH(
    ...
    kwiver::vital_c::DOT_SPTR_CACHE.get( obj )->set_score(
      std::string(
        class_name ), score );
  );
}
...
// ------------------------------------------------------------------
void
vital_detected_object_type_delete_score(
  vital_detected_object_type_t* obj,
  char* class_name )
{
  STANDARD_CATCH(
    "C::detected_object_type:delete_score", 0,
    kwiver::vital_c::DOT_SPTR_CACHE.get( obj )->delete_score(
      std::string(
        class_name ) );
  );
}
...
// ------------------------------------------------------------------
char**
vital_detected_object_type_class_names(
  vital_detected_object_type_t* obj,
  VITAL_UNUSED double thresh )
{
  STANDARD_CATCH(
    ...
    auto name_vector =
      kwiver::vital_c::DOT_SPTR_CACHE.get( obj )->class_names();
...
// ------------------------------------------------------------------
char**
vital_detected_object_type_all_class_names(
  VITAL_UNUSED vital_detected_object_type_t* obj )
{
  STANDARD_CATCH(
