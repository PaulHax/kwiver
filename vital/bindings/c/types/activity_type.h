...
VITAL_C_EXPORT
vital_activity_type_t* vital_activity_type_new_from_list(
...
VITAL_C_EXPORT
bool vital_activity_type_has_class_name(
  vital_activity_type_t* obj,
  char* class_name );

VITAL_C_EXPORT
double vital_activity_type_score(
  vital_activity_type_t* obj,
  char* class_name );
...
VITAL_C_EXPORT
void vital_activity_type_set_score(
  vital_activity_type_t* obj,
  char* class_name, double score );

VITAL_C_EXPORT
void vital_activity_type_delete_score(
  vital_activity_type_t* obj,
  char* class_name );

VITAL_C_EXPORT
char** vital_activity_type_class_names(
  vital_activity_type_t* obj,
  double thresh );
