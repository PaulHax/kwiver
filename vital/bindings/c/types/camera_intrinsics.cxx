...
vital_camera_intrinsics_new_default( vital_error_handle_t* eh )
{
  STANDARD_CATCH(
    ...
    auto ci_sptr =
      std::make_shared< kwiver::vital::simple_camera_intrinsics >();
 ...
 */
vital_camera_intrinsics_t*
vital_camera_intrinsics_new_partial(
  double focal_length,
...
void
vital_camera_intrinsics_destroy(
  vital_camera_intrinsics_t* ci,
  vital_error_handle_t* eh )
{
  STANDARD_CATCH(
...
double
vital_camera_intrinsics_get_focal_length(
  vital_camera_intrinsics_t* ci,
  vital_error_handle_t* eh )
{
  STANDARD_CATCH(
    "camera_intrinsics.get_focal_length", eh,
    return kwiver::vital_c::CAMERA_INTRINSICS_SPTR_CACHE.get(
      ci )->focal_length();
  );
  return 0;
}
...
vital_camera_intrinsics_get_principle_point(
  vital_camera_intrinsics_t* ci,
  vital_error_handle_t* eh )
{
  STANDARD_CATCH(
...
double
vital_camera_intrinsics_get_aspect_ratio(
  vital_camera_intrinsics_t* ci,
  vital_error_handle_t* eh )
{
  STANDARD_CATCH(
...
/// Get the skew value
double
vital_camera_intrinsics_get_skew(
  vital_camera_intrinsics_t* ci,
  vital_error_handle_t* eh )
{
  STANDARD_CATCH(
...
vital_camera_intrinsics_get_dist_coeffs(
  vital_camera_intrinsics_t* ci,
  vital_error_handle_t* eh )
{
  STANDARD_CATCH(
...
vital_camera_intrinsics_as_matrix(
  vital_camera_intrinsics_t* ci,
  vital_error_handle_t* eh )
{
  STANDARD_CATCH(
...
vital_eigen_matrix2x1d_t*
vital_camera_intrinsics_map_2d(
  vital_camera_intrinsics_t* ci,
  ...
  vital_error_handle_t* eh )
{
  STANDARD_CATCH(
    ...
    kwiver::vital::vector_2d& p2 =
      *reinterpret_cast< kwiver::vital::vector_2d* >( p );
...
vital_eigen_matrix2x1d_t*
vital_camera_intrinsics_map_3d(
  vital_camera_intrinsics_t* ci,
  ...
  vital_error_handle_t* eh )
{
  STANDARD_CATCH(
    ...
    kwiver::vital::vector_3d& p2 =
      *reinterpret_cast< kwiver::vital::vector_3d* >( p );
    kwiver::vital::vector_2d* v = new kwiver::vital::vector_2d(
      kwiver::vital_c::CAMERA_INTRINSICS_SPTR_CACHE.get( ci )->map( p2 )
    );
    return reinterpret_cast< vital_eigen_matrix2x1d_t* >( v );
...
vital_eigen_matrix2x1d_t*
vital_camera_intrinsics_unmap_2d(
  vital_camera_intrinsics_t* ci,
  vital_eigen_matrix2x1d_t* p,
  vital_error_handle_t* eh )
{
...
vital_eigen_matrix2x1d_t*
vital_camera_intrinsics_distort_2d(
  vital_camera_intrinsics_t* ci,
  vital_eigen_matrix2x1d_t* p,
  vital_error_handle_t* eh )
{
...
vital_eigen_matrix2x1d_t*
vital_camera_intrinsics_undistort_2d(
  vital_camera_intrinsics_t* ci,
  vital_eigen_matrix2x1d_t* p,
  vital_error_handle_t* eh )
{
