...
vital_detected_object_new_with_bbox(
...
vital_detected_object_t*
vital_detected_object_copy( vital_detected_object_t* obj )
{
  STANDARD_CATCH(
...
void
vital_detected_object_destroy( vital_detected_object_t* obj )
{
  STANDARD_CATCH(
...
vital_detected_object_bounding_box( vital_detected_object_t* obj )
{
  STANDARD_CATCH(
...
void
vital_detected_object_set_bounding_box(
...
double
vital_detected_object_confidence( vital_detected_object_t* obj )
{
  STANDARD_CATCH(
...
void
vital_detected_object_set_confidence(
  vital_detected_object_t* obj,
  double conf )
{
  STANDARD_CATCH(
...
vital_detected_object_get_type( vital_detected_object_t* obj )
{
  STANDARD_CATCH(
...
void
vital_detected_object_set_type(
  vital_detected_object_t*      obj,
  vital_detected_object_type_t* dot )
{
  STANDARD_CATCH(
...
int64_t
vital_detected_object_index( vital_detected_object_t* obj )
{
  STANDARD_CATCH(
...
void
vital_detected_object_set_index(
  vital_detected_object_t* obj,
  int64_t idx )
{
...
char*
vital_detected_object_detector_name( vital_detected_object_t* obj )
{
  std::string sname =
    kwiver::vital_c::DOBJ_SPTR_CACHE.get( obj )->detector_name();
  // + TBD need to return pointer to persistent string
  return 0;
}

void
vital_detected_object_detector_set_name(
  vital_detected_object_t* obj,
  char* name )
{
...
vital_image_t*
vital_detected_object_mask( VITAL_UNUSED vital_detected_object_t* obj )
{
...
void
vital_detected_object_set_mask(
  VITAL_UNUSED vital_detected_object_t* obj,
