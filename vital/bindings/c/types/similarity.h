...
vital_similarity_##S##_new(              \
  T s, vital_rotation_##S##_t const* r,  \
...
VITAL_C_EXPORT                  \
void                            \
vital_similarity_##S##_destroy( \
  vital_similarity_##S##_t * s, \
  vital_error_handle_t * eh );  \
                                \
/**
...
VITAL_C_EXPORT                         \
T                                      \
vital_similarity_##S##_scale(          \
  vital_similarity_##S##_t const* sim, \
  vital_error_handle_t * eh );         \
                                       \
/**
...
vital_similarity_##S##_translation(    \
  vital_similarity_##S##_t const* sim, \
  vital_error_handle_t * eh );         \
                                       \
/**
...
VITAL_C_EXPORT                           \
vital_similarity_##S##_t*                \
vital_similarity_##S##_compose(          \
  vital_similarity_##S##_t const* s_lhs, \
...
VITAL_C_EXPORT                             \
vital_eigen_matrix3x1##S##_t*              \
vital_similarity_##S##_vector_transform(   \
  vital_similarity_##S##_t const* s,       \
...
VITAL_C_EXPORT                           \
bool                                     \
vital_similarity_##S##_are_equal(        \
  vital_similarity_##S##_t const* s_lhs, \
  vital_similarity_##S##_t const* s_rhs, \
  vital_error_handle_t * eh );           \
                                         \
...
vital_similarity_##S##_to_matrix4x4( \
  vital_similarity_##S##_t const* s, \
  vital_error_handle_t * eh );       \
                                     \
/**
...
VITAL_C_EXPORT                           \
vital_similarity_##S##_t*                \
vital_similarity_##S##_from_matrix4x4(   \
  vital_eigen_matrix4x4##S##_t const* m, \
  vital_error_handle_t * eh );
