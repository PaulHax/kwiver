...
// ------------------------------------------------------------------
void
vital_activity_type_destroy( vital_activity_type_t* obj )
{
  STANDARD_CATCH(
...
// ------------------------------------------------------------------
vital_activity_type_t*
vital_activity_type_new_from_list(
  VITAL_UNUSED vital_activity_type_t* obj,
  size_t count,
  char** class_names,
...
// ------------------------------------------------------------------
bool
vital_activity_type_has_class_name(
  vital_activity_type_t* obj,
  char* class_name )
{
  STANDARD_CATCH(
    "C::activity_type::has_class_name", 0,
    return kwiver::vital_c::AT_SPTR_CACHE.get( obj )->has_class_name(
...
// ------------------------------------------------------------------
double
vital_activity_type_score( vital_activity_type_t* obj, char* class_name )
{
  STANDARD_CATCH(
    "C::activity_type::score", 0,
    return kwiver::vital_c::AT_SPTR_CACHE.get( obj )->score(
      std::string(
        class_name ) );
  );
  return 0;
...
// ------------------------------------------------------------------
char*
vital_activity_type_get_most_likely_class( vital_activity_type_t* obj )
{
  STANDARD_CATCH(
    ...
    std::string class_name;
    double score;
    kwiver::vital_c::AT_SPTR_CACHE.get( obj )->get_most_likely(
      class_name,
      score );
...
// ------------------------------------------------------------------
double
vital_activity_type_get_most_likely_score( vital_activity_type_t* obj )
{
  STANDARD_CATCH(
  ...
  double score )
{
  STANDARD_CATCH(
    ...
    kwiver::vital_c::AT_SPTR_CACHE.get( obj )->set_score(
      std::string(
        class_name ), score );
  );
}
...
// ------------------------------------------------------------------
void
vital_activity_type_delete_score(
  vital_activity_type_t* obj,
  char* class_name )
{
  STANDARD_CATCH(
    "C::activity_type::delete_score", 0,
    kwiver::vital_c::AT_SPTR_CACHE.get( obj )->delete_score(
      std::string(
        class_name ) );
  );
}
...
// ------------------------------------------------------------------
char**
vital_activity_type_class_names(
  vital_activity_type_t* obj,
...
// ------------------------------------------------------------------
char**
vital_activity_type_all_class_names( VITAL_UNUSED vital_activity_type_t* obj )
{
  STANDARD_CATCH(
