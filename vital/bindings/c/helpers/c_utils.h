...
{                                                                        \
  ...
  {                                                                      \
    ...
    PEH_eh_ptr_cast->message = ( char* ) malloc(                         \
  sizeof( char ) *                                                       \
  ( strlen( msg ) + 1 ) );                                               \
...
private:
  ...
  std::string
  get_log_prefix( vital_t const* ptr ) const
  {
    std::ostringstream ss;
