  ...
  vital_error_handle_t* eh )
{
  STANDARD_CATCH(
    ...
    auto a_sptr =
      vital_c::ALGORITHM_initialize_cameras_landmarks_SPTR_CACHE.get( algo );
    ...
    // input for caching.
    auto* cameras_after =
      reinterpret_cast< vital_camera_map_t* >( cameras_sptr.get() );
    if( *cameras != cameras_after )
  {
    ...
    *cameras = cameras_after;
    ...
    auto* landmarks_after =
      reinterpret_cast< vital_landmark_map_t* >( landmarks_sptr.get() );
