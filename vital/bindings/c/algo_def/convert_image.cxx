  ...
  vital_error_handle_t* eh )
{
  STANDARD_CATCH(
    ...
    kwiver::vital::algo::convert_image_sptr ci_sptr =
      kwiver::vital_c::ALGORITHM_convert_image_SPTR_CACHE.get( algo );
    kwiver::vital::image_container_sptr new_ic_sptr =
      ci_sptr->convert( ic_sptr );
