...
// ----------------------------------------------------------------------------
void
signed_range_check( bool negative )
{
...
TEST ( cxxopts, integer_parser )
{
  ...
  int8_t y = -1;
  EXPECT_THROW(
    cv::integer_parser< int8_t >( "0xfff", y ),
    cxxopts::argument_incorrect_type );
  EXPECT_EQ( y, -1 );
