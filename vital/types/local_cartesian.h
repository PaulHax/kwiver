...
/// \file
/// \brief This file contains the interface to a local geographic offset
/// coordinate system.
...
public:
  ...
  ///
  /// \param [in]     cartesian_coordinate : The location to convert in
  /// cartesian system
  /// \param [in,out] location             : The geo_point set with the computed
  /// WGS84 lon/lat/alt (degrees, meters)
  void convert_from_cartesian(
    vector_3d const& cartesian_coordinate,
    geo_point& location ) const;

  /// \brief Calculate the location of the provided geo location in the local
  /// coordinate system.
  ///
