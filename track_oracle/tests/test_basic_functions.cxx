...
{
  // beta tracks have the same track_id and frame_id, along with a frame
  // timestamp
...
to::dt::tracking::external_id::Type
index2trackID( size_t index )
{
  return ( index * 17 ) + 13;
}

to::dt::tracking::frame_number::Type
index2frameNum( size_t index )
{
  return ( index * 23 ) + 2;
}

to::dt::tracking::timestamp_usecs::Type
index2timestamp( size_t index )
{
