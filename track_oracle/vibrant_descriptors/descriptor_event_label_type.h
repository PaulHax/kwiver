...
struct VIBRANT_DESCRIPTORS_EXPORT single_event_label_type
{
  ...
  {}
  bool
  operator==( const single_event_label_type& rhs ) const
  {
    return
...
struct VIBRANT_DESCRIPTORS_EXPORT descriptor_event_label_type
{
  ...
  {}
  bool
  operator==( const descriptor_event_label_type& rhs ) const
  {
    //
...
VIBRANT_DESCRIPTORS_EXPORT std::ostream& operator<<(
  std::ostream& os,
  const descriptor_event_label_type& d );
VIBRANT_DESCRIPTORS_EXPORT std::istream& operator>>(
  std::istream& is,
  descriptor_event_label_type& d );
