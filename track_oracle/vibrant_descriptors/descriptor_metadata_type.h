...
struct VIBRANT_DESCRIPTORS_EXPORT descriptor_metadata_type
{
  ...
  bool
  operator==( const descriptor_metadata_type& a ) const
  {
    return ( this->gsd == a.gsd ) &&
           ( this->sensor_latitude == a.sensor_latitude ) &&
           ( this->sensor_longitude == a.sensor_longitude ) &&
           ( this->upper_left_corner_latitude ==
             a.upper_left_corner_latitude ) &&
           ( this->upper_left_corner_longitude ==
             a.upper_left_corner_longitude ) &&
           ( this->upper_right_corner_latitude ==
             a.upper_right_corner_latitude ) &&
           ( this->upper_right_corner_longitude ==
             a.upper_right_corner_longitude ) &&
           ( this->lower_left_corner_latitude ==
             a.lower_left_corner_latitude ) &&
           ( this->lower_left_corner_longitude ==
             a.lower_left_corner_longitude ) &&
           ( this->lower_right_corner_latitude ==
             a.lower_right_corner_latitude ) &&
           ( this->lower_right_corner_longitude ==
             a.lower_right_corner_longitude ) &&
           ( this->horizontal_field_of_view == a.horizontal_field_of_view ) &&
           ( this->vertical_field_of_view == a.vertical_field_of_view ) &&
           ( this->timestamp_microseconds_since_1970 ==
             a.timestamp_microseconds_since_1970 ) &&
           ( this->slant_range == a.slant_range );
  }
};

VIBRANT_DESCRIPTORS_EXPORT std::ostream& operator<<(
  std::ostream& os,
  const descriptor_metadata_type& );
VIBRANT_DESCRIPTORS_EXPORT std::istream& operator>>(
  std::istream& is,
  descriptor_metadata_type& );
