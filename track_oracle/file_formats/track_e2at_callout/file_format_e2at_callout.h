...
#include \
  <track_oracle/file_formats/track_e2at_callout/track_e2at_callout_export.h>
...
class TRACK_E2AT_CALLOUT_EXPORT file_format_e2at_callout : public
                                                           file_format_base
{
public:
  file_format_e2at_callout() : file_format_base( TF_E2AT_CALLOUT,
                                 "E2AT callouts (CSV)" )
  {
  ...
  virtual int
  supported_operations() const { return FF_READ; }

  // return a dynamically-allocated instance of the schema
  virtual track_base_impl*
  schema_instance() const { return new track_e2at_callout_type(); }
