...
struct TRACK_KWXML_EXPORT track_kwxml_type : public track_base< track_kwxml_type >
{
  ...
  track_kwxml_type()
    : video_id( Track.add_field< unsigned >( "video_id" ) ),
      ...
      activity_probability( Track.add_field< double >(
        "activity_probability" ) ),
      relevancy( Track.add_field< double >( "relevancy" ) ),
      type( Frame.add_field< std::string >( "type" ) ), // should be bool raw?

      descriptor_uthof( Track.add_field< std::vector< std::vector< double > > >(
        "descriptor_uthof" ) ),
      descriptor_rpidbn1( Track.add_field< std::vector< double > >(
        "descriptor_rpidbn1" ) ),
      descriptor_rpidbn2( Track.add_field< std::vector< double > >(
        "descriptor_rpidbn2" ) ),
      descriptor_kwsoti3( Track.add_field< std::vector< double > >(
        "descriptor_kwsoti3" ) ),
      descriptor_icsihog( Track.add_field< std::vector< double > >(
        "descriptor_icsihog" ) ),
      descriptor_texashog( Track.add_field< std::vector< double > >(
        "descriptor_texashog" ) ),
      descriptor_cornell( Track.add_field< std::vector< double > >(
        "descriptor_cornell" ) ),
      descriptor_pvo_raw_scores( Track.add_field< std::vector< double > >(
        "descriptor_pvo_raw_scores" ) ),
      descriptor_umdlds( Track.add_field< std::vector< double > >(
        "descriptor_umdlds" ) ),
      descriptor_umd_periodicity( Track.add_field< std::vector< double > >(
        "descriptor_umd_periodicity" ) ),
      descriptor_umdssm( Track.add_field< std::vector< double > >(
        "descriptor_umdssm" ) ),
      descriptor_cutic( Track.add_field< descriptor_cutic_type >(
        "descriptor_cutic" ) ),
      descriptor_cubof( Track.add_field< std::vector< double > >(
        "descriptor_cubof" ) ),
      descriptor_cu_texture( Track.add_field< std::vector< double > >(
        "descriptor_cu_texture" ) ),
      descriptor_cu_col_moment( Track.add_field< std::vector< double > >(
        "descriptor_cu_col_moment" ) ),
      descriptor_overlap( Track.add_field< descriptor_overlap_type >(
        "descriptor_overlap" ) ),
      descriptor_event_label( Track.add_field< descriptor_event_label_type >(
        "descriptor_event_label" ) ),
      descriptor_raw_1d( Track.add_field< descriptor_raw_1d_type >(
        "descriptor_raw_1d" ) ),
      descriptor_query_result_score( Track.add_field< double >(
        "descriptor_query_result_score" ) ),
      descriptor_metadata( Track.add_field< descriptor_metadata_type >(
        "descriptor_metadata" ) ),
      descriptor_motion( Track.add_field< descriptor_motion_type >(
        "descriptor_motion" ) ),
