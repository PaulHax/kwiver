...
struct SCORABLE_MGRS_EXPORT scorable_mgrs
{
  ...
  enum
  {
    DEFAULT_ZONE = 0, ZONE_BEGIN = DEFAULT_ZONE, ALT_ZONE = 1, N_ZONES = 2,
  };                                                                         // indices
...
//
// this.zone[] = [12, 19] ; other.zone[] = [12, 19]; ret = [DEFAULT_ZONE,
// ALT_ZONE]
//
// this.zone[] = [12, 19] ; other.zone[] = [19, 12]; ret = [ALT_ZONE,
// DEFAULT_ZONE]
//
// this.zone[] = [12, 19] ; other.zone[] = [12, 13]; ret = [DEFAULT_ZONE,
// N_ZONES]
//
// this.zone[] = [19, 13] ; other.zone[] = [12, 13]; ret = [N_ZONES, ALT_ZONE]
//
// this.zone[] = [19, 13] ; other.zone[] = [13, 12]; ret = [N_ZONES,
// DEFAULT_ZONE]
//
...
SCORABLE_MGRS_EXPORT std::ostream& operator<<(
  std::ostream& os,
  const scorable_mgrs& m );
SCORABLE_MGRS_EXPORT std::istream& operator>>(
  std::istream& os,
  scorable_mgrs& m );
