...
TRACK_ORACLE_INSTANTIATE_OLD_STYLE_DEFAULT_OUTPUT(
  std::vector< kwiver::vital::timestamp > );
...
TRACK_ORACLE_INSTANTIATE_OLD_STYLE_SPECIAL_OUTPUT(
  kwiver::track_oracle::frame_handle_list_type );
TRACK_ORACLE_INSTANTIATE_OLD_STYLE_SPECIAL_OUTPUT(
  kwiver::track_oracle::track_handle_list_type );
...
TRACK_ORACLE_INSTANTIATE_OLD_STYLE_SPECIAL_OUTPUT(
  kwiver::track_oracle::kpf_cset_type );
TRACK_ORACLE_INSTANTIATE_OLD_STYLE_SPECIAL_OUTPUT(
  kwiver::track_oracle::kpf_cset_sys_type );
TRACK_ORACLE_INSTANTIATE_OLD_STYLE_SPECIAL_OUTPUT(
  kwiver::track_oracle::kpf_cset_s2i_type );

#ifdef WIN32
TRACK_ORACLE_INSTANCES( std::pair< unsigned MACRO_COMMA unsigned > );
TRACK_FIELD_INSTANCES_OLD_STYLE_SPECIAL_OUTPUT(
  std::pair< unsigned MACRO_COMMA unsigned > );
...
#else
TRACK_ORACLE_INSTANTIATE_OLD_STYLE_SPECIAL_OUTPUT_COMMA(
  std::pair< unsigned,
    unsigned > );
#endif
