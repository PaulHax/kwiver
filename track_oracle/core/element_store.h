...
public:
  ...
  virtual std::vector< bool > exists(
    const std::vector< oracle_entry_handle_type >& sorted_hlist ) const;
  ...
  virtual std::ostream& emit_as_kwiver(
    std::ostream& os,
    const oracle_entry_handle_type& h, const std::string& indent ) const;
  virtual std::ostream& emit_as_csv(
    std::ostream& os,
    const oracle_entry_handle_type& h,
    bool emit_default_if_missing = false ) const;
