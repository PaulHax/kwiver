...
template KWIVER_IO_EXPORT bool kwiver::track_oracle::kwiver_io_base< T >::                                                            \
from_str( const std::string& s, Type & val ) const;                                                                                   \
template KWIVER_IO_EXPORT bool kwiver::track_oracle::kwiver_io_base< T >::                                                            \
read_xml( const TiXmlElement * e, Type & val ) const;                                                                                 \
template KWIVER_IO_EXPORT void kwiver::track_oracle::kwiver_io_base< T >::                                                            \
write_xml( std::ostream& os, const std::string& indent, const Type& val ) const;                                                      \
template KWIVER_IO_EXPORT std::vector< std::string > kwiver::track_oracle::                                                           \
kwiver_io_base< T >::csv_headers() const;                                                                                             \
template KWIVER_IO_EXPORT bool kwiver::track_oracle::kwiver_io_base< T >::                                                            \
from_csv( const std::map< std::string, std::string >&, Type& ) const;                                                                 \
