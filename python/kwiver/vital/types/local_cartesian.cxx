...
kv::vector_3d
local_cartesian_convert_to_cartesian(
  kv::local_cartesian const& self,
  kv::geo_point const& loc )
{
...
{
  py::class_< kwiver::vital::local_cartesian,
    std::shared_ptr< kwiver::vital::local_cartesian > >( m, "LocalCartesian" )
    .def(
    py::init< kv::geo_point const&, double >(), py::arg( "origin" ),
    py::arg( "orientation" ) = 0 )
    .def(
      "set_origin", &kv::local_cartesian::set_origin, py::arg( "origin" ),
      py::arg( "orientation" ) = 0 )
    ...
    .def(
      ...
      &kv::local_cartesian::convert_from_cartesian )
