...
void
integrate_depth_maps( py::module& m )
{
  py::class_< kwiver::vital::algo::integrate_depth_maps,
    ...
    .def(
      ...
      ( void( kwiver::vital::algo::integrate_depth_maps::* )
        ( vector_3d const&, vector_3d const&,
          std::vector< image_container_sptr > const&,
          std::vector< image_container_sptr > const&,
          std::vector< camera_perspective_sptr > const&,
    ...
    .def(
      ...
      ( void( kwiver::vital::algo::integrate_depth_maps::* )
        ( vector_3d const&, vector_3d const&,
          std::vector< image_container_sptr > const&,
          std::vector< camera_perspective_sptr > const&, image_container_sptr&,
          vector_3d & ) const ) &
      kwiver::vital::algo::integrate_depth_maps::integrate );
}
