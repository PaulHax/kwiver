...
static void add_algorithm(
  const std::string& impl_name, std::string const& description,
  py::object conc_t );

void mark_algorithm_as_loaded( const std::string& module_name );
static std::vector< std::string > implementation_names(
  const std::string& algorithm_name );

class python_algorithm_factory : public kwiver::vital::algorithm_factory
{
public:
  python_algorithm_factory(
...
{
  m.def(
    "has_algorithm_impl_name", &kwiver::vital::has_algorithm_impl_name,
  ...
  m.def(
    "mark_algorithm_as_loaded", &mark_algorithm_as_loaded,
    py::call_guard< pybind11::gil_scoped_release >(),
  ...
  m.def(
    "create_algorithm", &kwiver::vital::create_algorithm,
    py::call_guard< pybind11::gil_scoped_release >(),
...
static void
add_algorithm(
  std::string const& impl_name, std::string const& description,
  py::object conc_f )
{
...
void
mark_algorithm_as_loaded( const std::string& name )
{
  kwiver::vital::plugin_manager& vpm =
    kwiver::vital::plugin_manager::instance();
...
// ------------------------------------------------------------------
bool
is_algorithm_loaded( const std::string& name )
{
  kwiver::vital::plugin_manager& vpm =
    kwiver::vital::plugin_manager::instance();
...
implementation_names( const std::string& algorithm_name )
{
  kwiver::vital::plugin_manager& vpm =
    kwiver::vital::plugin_manager::instance();
