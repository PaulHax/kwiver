  ...
  const std::string implementation_name )
{
  ...
  py::class_< kwiver::vital::algorithm_def< implementation >,
    ...
    .def_static(
      "create",
      &kwiver::vital::algorithm_def< implementation >::create )
    .def_static(
      "registered_names",
      &kwiver::vital::algorithm_def< implementation >::registered_names )
    .def_static(
      "get_nested_algo_configuration",
      &kwiver::vital::algorithm_def< implementation >::
      get_nested_algo_configuration )
    .def_static(
      "set_nested_algo_configuration",
      [](std::string const& name, config_block_sptr config){
        typename algorithm_def< implementation >::base_sptr ret;
        algorithm_def< implementation >::set_nested_algo_configuration(
          name,
          config, ret );
        return ret;
      } )
