...
public:
  ...
  estimate_transform(
    ...
    std::vector< kwiver::vital::vector_3d >  const& to )  const override
  {
  ...
  estimate_transform(
    ...
    std::vector< kwiver::vital::landmark_sptr >  const& to )  const override
  {
    PYBIND11_OVERLOAD_PURE(
      kwiver::vital::similarity_d,
      kwiver::vital::algo::estimate_similarity_transform,
  ...
  estimate_transform(
    ...
    kwiver::vital::camera_map_sptr const to )  const override
  {
    PYBIND11_OVERLOAD_PURE(
      kwiver::vital::similarity_d,
      kwiver::vital::algo::estimate_similarity_transform,
  ...
  estimate_transform(
    ...
    kwiver::vital::landmark_map_sptr const to )  const override
  {
    PYBIND11_OVERLOAD_PURE(
      kwiver::vital::similarity_d,
      kwiver::vital::algo::estimate_similarity_transform,
