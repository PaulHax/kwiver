    ...
    nj_( pixel_height )
{
  ...
  wip.set_interpolator(
    kwiver::arrows::super3d::warp_image_parameters::LINEAR );
}
  ...
  PixT fill )
{
  ...
  char buf[ 60 ];
  sprintf(
    buf, "images/slice%2f_frame%d_%d.png", wpts[ 0 ][ 2 ], f,
    wip.interpolator_ );
...
template void world_space
::warp_image_to_depth(
  const vil_image_view< double >& in,
