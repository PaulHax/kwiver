...
TEST ( track, create )
{
  ...
  EXPECT_NE(
    nullptr,
    create_algorithm< algo::data_serializer >( "kwiver:json:track" ) );
}
...
TEST ( track_set, create )
{
  ...
  EXPECT_NE(
    nullptr,
    create_algorithm< algo::data_serializer >( "kwiver:json:track_set" ) );
}
...
TEST ( track_state, create )
{
  ...
  EXPECT_NE(
    nullptr,
    create_algorithm< algo::data_serializer >( "kwiver:json:track_state" ) );
}
