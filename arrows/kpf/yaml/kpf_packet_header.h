...
struct KPF_YAML_EXPORT packet_header_t
{
  ...
  packet_style style;
  int domain;
  packet_header_t() : style( packet_style::INVALID ),
                      domain( NO_DOMAIN ) {}
  packet_header_t( packet_style s, int d ) : style( s ),
                                             domain( d ) {}
  explicit packet_header_t( packet_style s ) : style( s ),
                                               domain( NO_DOMAIN ) {}
};

KPF_YAML_EXPORT bool operator==(
  const packet_header_t& lhs,
...
KPF_YAML_EXPORT std::ostream& operator<<(
  std::ostream& os,
