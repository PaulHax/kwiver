...
{
public:
  explicit record_yaml_writer( std::ostream& os ) : s( os ),
                                                    line_started( false ),
                                                    schema(
                                                      schema_style::UNSPECIFIED ),
                                                    has_meta( false ) {}

  friend KPF_YAML_EXPORT record_yaml_writer& operator<<(
    record_yaml_writer& w,
    const packet_t& p );
  friend KPF_YAML_EXPORT record_yaml_writer& operator<<(
    record_yaml_writer& w,
    const writer< canonical::id_t >& io );
  friend KPF_YAML_EXPORT record_yaml_writer& operator<<(
    record_yaml_writer& w,
    const writer< canonical::bbox_t >& io );
  friend KPF_YAML_EXPORT record_yaml_writer& operator<<(
    record_yaml_writer& w,
    const writer< canonical::timestamp_t >& io );
  friend KPF_YAML_EXPORT record_yaml_writer& operator<<(
    record_yaml_writer& w,
    const writer< canonical::kv_t >& io );
  friend KPF_YAML_EXPORT record_yaml_writer& operator<<(
    record_yaml_writer& w,
    const writer< canonical::conf_t >& io );
  friend KPF_YAML_EXPORT record_yaml_writer& operator<<(
    record_yaml_writer& w,
    const writer< canonical::cset_t >& io );
  friend KPF_YAML_EXPORT record_yaml_writer& operator<<(
    record_yaml_writer& w,
    const writer< canonical::cset_t >& io );
  friend KPF_YAML_EXPORT record_yaml_writer& operator<<(
    record_yaml_writer& w,
    const writer< canonical::eval_t >& io );
  friend KPF_YAML_EXPORT record_yaml_writer& operator<<(
    record_yaml_writer& w,
    const writer< canonical::poly_t >& io );
  friend KPF_YAML_EXPORT record_yaml_writer& operator<<(
    record_yaml_writer& w,
    const writer< canonical::meta_t >& io );
  friend KPF_YAML_EXPORT record_yaml_writer& operator<<(
    record_yaml_writer& w,
    const writer< canonical::timestamp_range_t >& io );
  friend KPF_YAML_EXPORT record_yaml_writer& operator<<(
    record_yaml_writer& w,
    const writer< canonical::activity_t >& io );
  friend KPF_YAML_EXPORT record_yaml_writer& operator<<(
    record_yaml_writer& w,
    const private_endl_t& );
...
KPF_YAML_EXPORT
record_yaml_writer& operator<<(
  record_yaml_writer& w,
  const writer< canonical::id_t >& io );

KPF_YAML_EXPORT
packet_bounce_t& operator>>(
  packet_bounce_t& w,
  const writer< canonical::id_t >& io );
