...
{
  d_->max_kpts = config->get_value< unsigned int >(
    "max_keypoints",
    d_->max_kpts );
  ...
  vital::image_container_sptr mask ) const
{
  ...
  d_->detector.smooth_and_detect(
    img, feature_data.kptmap_, feature_data.features_, feature_data.numfeat_,
