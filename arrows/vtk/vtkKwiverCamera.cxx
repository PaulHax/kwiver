...
void
BuildCamera(
  kwiver::arrows::vtk::vtkKwiverCamera* out,
  ...
  kwiver::vital::camera_intrinsics_sptr const& ci )
{
  ...
  double const fov =
    vtkMath::DegreesFromRadians(
      2.0 *
      atan( 0.5 * imageHeight / focalLength ) );
...
void
vtkKwiverCamera
::SetCamera( kwiver::vital::camera_perspective_sptr const& camera )
{
...
vtkKwiverCamera
::ProjectPoint(
  kwiver::vital::vector_3d const& in,
  double ( & out )[ 2 ] )
{
...
kwiver::vital::vector_3d
vtkKwiverCamera
::UnprojectPoint( double pixel[ 2 ] )
{
  auto const depth = this->KwiverCamera->depth(
    kwiver::vital::vector_3d(
      0, 0,
      0 ) );
...
double
vtkKwiverCamera
::Depth( kwiver::vital::vector_3d const& point ) const
{
...
::ScaleK( double factor )
{
  ...
  kwiver::vital::simple_camera_perspective scaledCamera(
    this->KwiverCamera->center(),
...
// ----------------------------------------------------------------------------
vtkSmartPointer< vtkKwiverCamera >
vtkKwiverCamera
::ScaledK( double factor )
{
...
vtkSmartPointer< vtkKwiverCamera >
vtkKwiverCamera
::CropCamera( int i0, int ni, int j0, int nj )
{
  kwiver::vital::simple_camera_intrinsics newIntrinsics(
    *this->KwiverCamera->intrinsics() );
  ...
  kwiver::vital::simple_camera_perspective cropCam(
    this->KwiverCamera->center(),
    this->KwiverCamera->rotation(),
    newIntrinsics );
...
void
vtkKwiverCamera
::GetFrustumPlanes( double planes[ 24 ] )
{
...
void
vtkKwiverCamera
::GetTransform( vtkMatrix4x4* out, double const plane[ 4 ] )
{
  // Build camera matrix
...
void
vtkKwiverCamera
::DeepCopy( vtkKwiverCamera* source )
{
