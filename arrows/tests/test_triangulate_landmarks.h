...
void
test_from_solution( kwiver::vital::algo::triangulate_landmarks& tri_lm )
{
  ...
  double init_rmse =
    kwiver::arrows::mvg::reprojection_rmse(
      cameras->cameras(),
      landmarks->landmarks(),
      tracks->tracks() );
...
void
test_noisy_landmarks( kwiver::vital::algo::triangulate_landmarks& tri_lm )
{
  using namespace kwiver::vital;
...
void
test_zero_landmarks( kwiver::vital::algo::triangulate_landmarks& tri_lm )
{
  using namespace kwiver::vital;
...
void
test_subset_cameras( kwiver::vital::algo::triangulate_landmarks& tri_lm )
{
  using namespace kwiver::vital;
...
void
test_subset_landmarks( kwiver::vital::algo::triangulate_landmarks& tri_lm )
{
  using namespace kwiver::vital;
...
void
test_subset_tracks( kwiver::vital::algo::triangulate_landmarks& tri_lm )
{
  using namespace kwiver::vital;
...
void
test_noisy_tracks( kwiver::vital::algo::triangulate_landmarks& tri_lm )
{
  using namespace kwiver::vital;
