  ...
  vector_2d const& img_pt )
{
      ...
      img_pt_y >= dm_height )
  {
    throw std::invalid_argument(
      "Provided image point is outside of image "
      "bounds" );
  }
  ...
  vital::bounding_box< double > const bbox )
{
  ...
  std::tie( world_pos_bottom, world_pos_top ) =
    backproject_wrt_height(
      src_camera, depth_map, bbox_bottom_center,
      bbox_top_center );
  ...
  return vital::bounding_box< double >(
    dest_bbox_min_x, dest_bbox_min_y,
    dest_bbox_max_x, dest_bbox_max_y );
}
