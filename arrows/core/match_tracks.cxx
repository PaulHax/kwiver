  ...
  vital::frame_id_t target_frame )
{
  ...
  feature_set_sptr current_features =
    current_tracks->frame_features( current_frame );
  // extract the set of descriptor on the current frame
  descriptor_set_sptr current_descriptors =
    current_tracks->frame_descriptors( current_frame );
  ...
  vital::frame_id_t target_frame )
{
  ...
  feature_set_sptr target_features =
    target_tracks->frame_features( target_frame );
  // extract the set of descriptor on the target frame
  descriptor_set_sptr target_descriptors =
    target_tracks->frame_descriptors( target_frame );
  ...
  vital::descriptor_set_sptr target_descriptors )
{
  ...
  match_set_sptr mset = matcher->match(
