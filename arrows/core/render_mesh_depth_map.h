...
vital::image_container_sptr render_mesh_depth_map(
...
/// \return height map
KWIVER_ALGO_CORE_EXPORT
vital::image_container_sptr render_mesh_height_map(
  kwiver::vital::mesh_sptr mesh,
  ...
  vital::image_of< T >& img )
{
  ...
  auto Va = triangle_attribute_vector(
    v1, v2, v3, attrib_v1_d, attrib_v2_d,
    attrib_v3_d );
...
/// This functions renders a triangle and fills every pixel with value where
/// depth_img is updated
///
/// \param v1 [in] 2D triangle point
/// \param v2 [in] 2D triangle point
/// \param v3 [in] 2D triangle point
