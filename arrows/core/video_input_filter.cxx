...
// ----------------------------------------------------------------------------
void video_input_filter::initialize()
{
...
::check_configuration( vital::config_block_sptr config ) const
{
  ...
  return retcode &&
         vital::check_nested_algo_configuration<vital::algo::video_input>( "video_input", config );
}
...
::open( std::string name )
{
  if ( ! d->d_video_input() )
  {
    ...
    //      "invalid video_input." );
    VITAL_THROW( kwiver::vital::algorithm_configuration_exception, this->interface_name(), this->plugin_name(),"invalid video_input." );
  }
