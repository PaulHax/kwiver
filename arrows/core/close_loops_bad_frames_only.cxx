...
::get_configuration() const
{
  ...
  config->set_value(
    "percent_match_req", percent_match_req_,
  ...
  vital::image_container_sptr ) const
{
  ...
  for(; frame_to_test > last_frame_to_test; frame_to_test-- )
  {
    ...
    // run matcher alg
    vital::match_set_sptr mset = matcher_->match(
    ...
    if( 2 * mset->size() >=
        static_cast< unsigned >( percent_match_req_ * total_features ) )
    {
