...
::set_configuration( vital::config_block_sptr in_config )
{
  ...
  istream >> d_->grid_spacing[ 0 ] >> d_->grid_spacing[ 1 ] >>
  d_->grid_spacing[ 2 ];
}
  ...
  vector_3d& spacing ) const
{
  ...
  cuda_initalize(
    d_->grid_dims, orig.data(), spacing.data(),
