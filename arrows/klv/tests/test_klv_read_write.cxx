...
TEST ( klv, read_imap )
{
  ...
  CALL_TEST(
    test_read_imap, 0x000000, 3, klv_imap{      -900.0 }, -900.0,
    19000.0 );
  CALL_TEST(
    test_read_imap, 0x038400, 3, klv_imap{         0.0 }, -900.0,
    19000.0 );
  CALL_TEST(
    test_read_imap, 0x038E00, 3, klv_imap{        10.0 }, -900.0,
    19000.0 );
  CALL_TEST(
    test_read_imap, 0xE80000, 3, klv_imap{ -double_inf }, -900.0,
    19000.0 );

  // Values from examples in ST1201.4, Table 7
  CALL_TEST(
    test_read_imap, 0x0000, 2, klv_imap{ 0.1 },               0.1,
    0.9 );
  CALL_TEST(
    test_read_imap, 0x3333, 2, klv_imap{ 0.499993896484375 }, 0.1,
    0.9 );
  CALL_TEST(
    test_read_imap, 0x6666, 2, klv_imap{ 0.899987792968750 }, 0.1,
    0.9 );
  CALL_TEST(
    test_read_imap, 0xE800, 2, klv_imap{ -double_inf },       0.1,
    0.9 );

  // Special values
  CALL_TEST(
    test_read_imap, 0xC800000000, 5, klv_imap{ +double_inf },  1.0,
    2.0 );
  CALL_TEST(
    test_read_imap, 0xE800000000, 5, klv_imap{ -double_inf },  1.0,
    2.0 );
  CALL_TEST(
    test_read_imap, 0xD000000000, 5, klv_imap::nan( false, false, 0 ),
    1.0, 2.0 );
  CALL_TEST(
    test_read_imap, 0xF000000000, 5, klv_imap::nan( false, true,  0 ),
    1.0, 2.0 );
  CALL_TEST(
    test_read_imap, 0xD800000000, 5, klv_imap::nan( true,  false, 0 ),
    1.0, 2.0 );
  CALL_TEST(
    test_read_imap, 0xF800000000, 5, klv_imap::nan( true,  true,  0 ),
    1.0, 2.0 );
  ...
  CALL_TEST(
    test_read_imap, 0x00C01234, 3, klv_imap::user_defined( 0x1234 ),
    1.0, 2.0 );
  CALL_TEST(
    test_read_imap, 0xC0001234, 4, klv_imap::user_defined( 0x1234 ),
    1.0, 2.0 );
...
TEST ( klv, write_imap )
{
  ...
  CALL_TEST(
    test_write_imap, klv_imap{         0.5 },
    klv_imap{ 0.499993896484375 }, 2, 0.1, 0.9 );
  CALL_TEST(
    test_write_imap, klv_imap{         0.9 },
    klv_imap{ 0.899987792968750 }, 2, 0.1, 0.9 );
  ...
  CALL_TEST(
    test_write_imap, klv_imap::nan( true,  true,  ( 1ull << 59 ) - 1 ),
    8, 0.0, 1.0 );
  ...
  CALL_TEST(
    test_write_imap, klv_imap::user_defined( ( 1ull << 59 ) - 1 ), 8,
    0.0, 1.0 );
}
