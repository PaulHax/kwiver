...
enum klv_0903_vtarget_pack_tag : klv_lds_key
{
  ...
  KLV_0903_VTARGET_BBOX_TOP_LEFT_PIXEL                = 2,
  KLV_0903_VTARGET_BBOX_BOTTOM_RIGHT_PIXEL            = 3,
  ...
  KLV_0903_VTARGET_BBOX_TOP_LEFT_LATITUDE_OFFSET      = 13,
  KLV_0903_VTARGET_BBOX_TOP_LEFT_LONGITUDE_OFFSET     = 14,
  KLV_0903_VTARGET_BBOX_BOTTOM_RIGHT_LATITUDE_OFFSET  = 15,
  KLV_0903_VTARGET_BBOX_BOTTOM_RIGHT_LONGITUDE_OFFSET = 16,
  KLV_0903_VTARGET_LOCATION                           = 17,
  KLV_0903_VTARGET_GEOSPATIAL_CONTOUR_SERIES          = 18,
  KLV_0903_VTARGET_CENTROID_ROW                       = 19,
  KLV_0903_VTARGET_CENTROID_COLUMN                    = 20,
  KLV_0903_VTARGET_FPA_INDEX                          = 21, // Deprecated
  KLV_0903_VTARGET_ALGORITHM_ID                       = 22,
  KLV_0903_VTARGET_DETECTION_STATUS                   = 23,

  // Note the jump in tag number here
  KLV_0903_VTARGET_VMASK                              = 101,
  KLV_0903_VTARGET_VOBJECT                            = 102, // Deprecated
  KLV_0903_VTARGET_VFEATURE                           = 103, // Deprecated
