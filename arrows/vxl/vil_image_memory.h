...
public:
  ...
  memory_chunk() const { return vil_data_; }
...
public:
  ...
  /// Pointer to the first element of data
  virtual void*
  const_data() const { return image_data_->data(); }
  ...
  vital::image_memory_sptr
  memory() const { return image_data_; }
...
//  However, it also detects when the incoming memory is already a wrapper
// around
