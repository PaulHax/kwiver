...
vital::covariance_< 3, T > transform(
...
KWIVER_ALGO_MVG_EXPORT
vital::camera_perspective_sptr transform(
...
/// transformation
KWIVER_ALGO_MVG_EXPORT
vital::camera_map_sptr transform(
