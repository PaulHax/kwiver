...
{
public:
  PLUGGABLE_IMPL( initialize_cameras_landmarks,
    ...
    PARAM_DEFAULT(feature_angle_threshold, double,
                    "feature must have this triangulation angle to keep, in degrees", 2.0),

    PARAM_DEFAULT(do_final_sfm_cleaning, bool,
    ...
    PARAM(bundle_adjuster,vital::algo::bundle_adjust_sptr, 
        "pointer to the nested algorithm"),
    PARAM(global_bundle_adjuster,vital::algo::bundle_adjust_sptr, 
        "pointer to the nested algorithm"),
    PARAM(estimate_pnp,vital::algo::estimate_pnp_sptr, 
        "pointer to the nested algorithm"),
    PARAM(canonical_estimator,vital::algo::estimate_canonical_transform_sptr, 
        "pointer to the nested algorithm"),
    PARAM(similarity_estimator,vital::algo::estimate_similarity_transform_sptr, 
        "pointer to the nested algorithm")
  )
  /// Destructor
