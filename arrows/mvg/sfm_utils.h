...
///
/// Change the parameters of the camera appropriately to account for the
/// cropping
...
/// \param [in] min_landmark_inliers minimum number of inlier measurements to
/// keep a landmark.
///            Set to -1 to ignore.
...
void
remove_landmarks(
  const std::set< vital::track_id_t >& to_remove,
...
/// \param [in] lms the landmarks in the view graph.
/// \param [in] tracks the track set
/// \param [in] coverage_thresh images that have less than this  fraction [0 -
/// 1]
...
/// of cameras.
/// \param [in,out] cams the cameras in the view graph.  Removed cameras are set
/// to null.
/// \param [in,out] lms the landmarks in the view graph.  Removed landmarks are
/// set to null.
/// \param [in] tracks the track set
/// \param [in] triang_cos_ang_thresh largest angle rays intersecting landmark
/// must
///             have less than this cos angle for landmkark to be kept.
/// \param [out] removed_cams frame ids of cameras that are removed while
/// cleaning
...
/// \param [in] image_coverage_threshold images must have this fraction [0 - 1]
/// of
