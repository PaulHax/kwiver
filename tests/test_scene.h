  ...
  const kwiver::vital::vector_3d& c = kwiver::vital::vector_3d( 0, 0, 0 ) )
{
  ...
  s /= 2.0;
  landmarks[ 0 ] = landmark_sptr(
    new landmark_d(
      c + vector_3d(
        -s, -s,
        -s ) ) );
  landmarks[ 1 ] = landmark_sptr(
    new landmark_d(
      c + vector_3d(
        -s, -s,
        s ) ) );
  landmarks[ 2 ] = landmark_sptr(
    new landmark_d(
      c + vector_3d(
        -s,  s,
        -s ) ) );
  landmarks[ 3 ] = landmark_sptr(
    new landmark_d(
      c + vector_3d(
        -s,  s,
        s ) ) );
  landmarks[ 4 ] = landmark_sptr(
    new landmark_d(
      c + vector_3d(
        s, -s,
        -s ) ) );
  landmarks[ 5 ] = landmark_sptr(
    new landmark_d(
      c + vector_3d(
        s, -s,
        s ) ) );
  landmarks[ 6 ] = landmark_sptr(
    new landmark_d(
      c + vector_3d(
        s,  s,
        -s ) ) );
  landmarks[ 7 ] = landmark_sptr(
    new landmark_d(
      c + vector_3d(
        s,  s,
        s ) ) );
...
kwiver::vital::mesh_sptr
grid_mesh(
  unsigned width, unsigned height, double scale = 1.0,
...
kwiver::vital::landmark_map_sptr
init_landmarks(
  kwiver::vital::landmark_id_t num_lm,
  const kwiver::vital::vector_3d& c = kwiver::vital::vector_3d( 0, 0, 0 ) )
{
  using namespace kwiver::vital;
...
camera_seq(
  kwiver::vital::frame_id_t num_cams,
...
kwiver::vital::camera_map_sptr
camera_seq(
  kwiver::vital::frame_id_t num_cams = 20,
...
init_cameras(
  kwiver::vital::frame_id_t num_cams = 20,
  kwiver::vital::simple_camera_intrinsics K =
  kwiver::vital::simple_camera_intrinsics( 1000,
  ...
  double pos_stdev = 1.0, double rot_stdev = 1.0 )
{
  ...
  for( camera_map::map_camera_t::value_type const& p : cameras->cameras() )
  {
    ...
    auto c =
      std::dynamic_pointer_cast< vital::camera_perspective >(
        cam_ptr->clone() );
...
subset_tracks(
  kwiver::vital::feature_track_set_sptr in_tracks,
  double keep_frac = 0.75 )
{
  using namespace kwiver::vital;
